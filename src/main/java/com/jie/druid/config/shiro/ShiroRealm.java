...
public class ShiroRealm extends AuthorizingRealm {
    ...
    private ITUserDataPermissionService userDataPermissionService;

    @Autowired
    public void setMenuService(ITMenuService menuService) {
    ...
    @Autowired
    public void setRoleService(ITRoleService roleService) {
        this.roleService = roleService;
    }
    @Autowired
    public void setUserDataPermissionService(ITUserDataPermissionService userDataPermissionService) {

...
import com.jie.druid.mapper.TLogDao;
...
public class TLogServiceImpl extends ServiceImpl<TLogDao, SystemLog> implements ITLogService {
    ...
    public IPage<SystemLog> findLogs(SystemLog systemLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "createTime", Constants.ORDER_DESC, true);
